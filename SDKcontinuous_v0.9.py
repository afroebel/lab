# -*- coding: utf-8 -*-
"""
Created on Tue Nov 16 09:54:49 2021
...
def savetxt():
    ...
    np.savetxt(datestr+'_'+str(rep_rate)+'_'+str(offset)+'_'+str(timeavg)+'secavg_bg2.txt', avg)
...
avg, argmaxs, rep_rate, offset, timeavg = collectspectrum(79228400, 100, 4, 300)
