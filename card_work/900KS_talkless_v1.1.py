...
def avgcollect(num_avg, fno):
    ...
    if __name__ == "__main__":
        ...
        f = open('m'+str(fno).zfill(3)+'x'+str(num_avg)+"avgopfile.txt", "w")  ##THIS WAY IT DOES NOT GET SORTED PROPERLY
        average.tofile(f)
        f.close()
            
        print(str(num_avg)+'averages, measurement'+str(fno)+' time with opfilesave ' + str(time.time() - nustartT))  #about 5 ms!!
